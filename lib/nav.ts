...
const NAV_BY_ROLE: Record<Role, NavItem[]> = {
  ...
  admin: [
    ...
    { href: "/admin/enquiries", label: "Enquiries", short: "Inbox", icon: Inbox, group: "Operate" },
    { href: "/admin/patient-enquiries", label: "Patient enquiries", short: "Patients", icon: HeartHandshake, group: "Operate" },
    ...
    { href: "/admin/regulatory", label: "Regulatory", short: "Filings", icon: Stamp, group: "Govern" },
